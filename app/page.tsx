...
export default function DCOReferralSystem() {
  ...
  const stats = {
    ...
    activeReferrals: referralData.filter((r) => r.status !== "EMI Complete").length,
    totalEarnings: referralData.reduce((sum, r) => sum + r.totalEarned, 0),
    pendingPayouts: referralData.filter((r) => r.payout2 === 0 && r.status === "Delivered").length,
    conversionRate: 76.5,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button onClick={() => setShowCreateReferral(true)} className="bg-blue-600 hover:bg-blue-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{stats.activeReferrals}</div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Awaiting EMI completion</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Referral to sale</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">₹{stats.avgEarningsPerReferral}</div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="dashboard" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Latest updates on your referrals</CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Referred by {referral.referrerName} • {referral.vehicleModel}
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        {getStatusBadge(referral.status)}
                        <p className="text-sm text-muted-foreground mt-1">₹{referral.totalEarned} earned</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <TabsContent value="referrals" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Search & Filter Referrals</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="EMI Complete">EMI Complete</SelectItem>
                    </SelectContent>
                  </Select>
                      ...
                      <TableRow key={referral.id}>
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            ...
                            <Button variant="ghost" size="sm" onClick={() => copyToClipboard(referral.referralCode)}>
                        ...
                        <TableCell>
                          <div>
                            <p className="font-medium">{referral.customerName}</p>
                            <p className="text-sm text-muted-foreground">{referral.customerPhone}</p>
                          </div>
                        </TableCell>
                        ...
                        <TableCell>
                          <span className={referral.payout1 > 0 ? "text-green-600 font-medium" : "text-gray-400"}>
                            ₹{referral.payout1}
                          </span>
                        </TableCell>
                        <TableCell>
                          <span className={referral.payout2 > 0 ? "text-green-600 font-medium" : "text-gray-400"}>
                            ₹{referral.payout2}
                          </span>
                        </TableCell>
                        <TableCell>
                          <span className="font-medium text-green-600">₹{referral.totalEarned}</span>
                        </TableCell>
                        <TableCell>
                          <Button
                            variant="ghost"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Current referral payout breakdown</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Paid upon successful delivery</p>
                        </div>
                      </div>
                      <div className="text-right">
                    ...
                    <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Paid after 3 consecutive EMIs</p>
                        </div>
                      </div>
                      <div className="text-right">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">System blocks self-referrals automatically</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Shield className="w-5 h-5 text-green-600" />
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Prevents multiple referrals for same number</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Shield className="w-5 h-5 text-green-600" />
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Real-time validation with customer database</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
      ...
      <Dialog open={showCreateReferral} onOpenChange={setShowCreateReferral}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Create a new referral code for sharing with potential customers</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="location" placeholder="e.g., MH, GJ, UP" className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="id" className="text-right">
                ID
              </Label>
              <Input id="id" placeholder="Your unique ID" className="col-span-3" />
            </div>
          </div>
      ...
      <Dialog open={showShareDialog} onOpenChange={setShowShareDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Share your referral code across different platforms</DialogDescription>
          </DialogHeader>
          {selectedReferral && (
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <code className="text-lg font-mono">{selectedReferral.referralCode}</code>
                  <Button variant="ghost" size="sm" onClick={() => copyToClipboard(selectedReferral.referralCode)}>
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button
                  ...
                  onClick={() => shareReferral("whatsapp", selectedReferral.referralCode)}
                >
                ...
                <Button
                  variant="outline"
                  className="flex flex-col items-center p-4 h-auto bg-transparent"
                  onClick={() => shareReferral("driver-app", selectedReferral.referralCode)}
                >
                ...
                <Button
                  variant="outline"
                  className="flex flex-col items-center p-4 h-auto bg-transparent"
                  onClick={() => shareReferral("meta", selectedReferral.referralCode)}
                >
